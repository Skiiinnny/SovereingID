...
Registrar cómo SovereignID aborda hallazgos concretos de SonarQube y Roslyn
(S2094, S2326, CA1859, CA1845) de forma explícita y alineada con la
...
- **AND** it is consistent with the `solution-architecture` specification for
  that rule family
