...
Define the Auth bounded context contract for parsing EIP-4361 (SIWE) message
payloads: explicit success/failure via `Result`, structured `siwe_parse_failed`
errors, and consistent propagation through the verify flow.
