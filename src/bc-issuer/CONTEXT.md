...
- **Slice A (Opción A):** emitir credenciales como documentos **W3C Verifiable Credentials Data Model 1.1** (JSON-LD) con prueba de firma **EIP-712** según decisión de arquitectura del repo.
...
| **VP** | Verifiable Presentation — sobre W3C que empaqueta uno o más VCs y la prueba del titular; es lo que recibe el **Verifier** (acordado: slice A incluye flujo de verificación sobre VP mínima). |
